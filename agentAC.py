...
from modelAC import ActorNet, CriticNet, Actor_Trainer, Critic_Trainer
...
class Agent:
    ...
    def __init__(self):
        ...
        self.actor_model = ActorNet(13, 256, 3)
        self.critic_model = CriticNet(13, 256, 3)
        self.actor_trainer = Actor_Trainer(self.actor_model, self.critic_model, lr=LR, alpha = self.alpha)
        self.critic_trainer = Critic_Trainer(self.critic_model, lr = LR, beta = self.beta)
    ...
    def train_long_memory(self):
        ...
        self.actor_trainer.train_step(states, actions, next_states, dones)
    ...
    def train_short_memory(self, state, action, reward, next_state, done):
        self.actor_trainer.train_step(state, action, next_state, done)
...
def train():
    ...
    while True:
        ...
        if done:
            ...
            plot(plot_scores, plot_mean_scores, "Q-Net with Experience Replay and Actor (Q-Net) Critic")
