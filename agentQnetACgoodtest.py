...
from modelQnetACgood import ActorNet, CriticNet, ACTrainer
...
class Agent:
    ...
    def __init__(self):
        ...
        self.critic_model = CriticNet(16, 128, 256, 3)
...
def train():
    ...
    while agent.n_games < 2000:
        ...
        if done:
            ...
            if agent.n_games < 250 or score >= 0.1 * mean_score or agent.n_games%10 == 0:
                agent.train_long_memory()
        ...
        if (agent.n_games > 500 and mean_score < 1):
            return True
